        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900">
                    <div class="card mt-5">
                        <div class="card-body">
                            <h3 class="text-2xl font-semibold mb-6">Actualizar Cuota</h3>
                            <form action="{{ route('fees.update', $cuota->id) }}" method="POST">
                                @csrf
                                @method('PUT')
                                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                    <div class="col-span-1 md:col-span-2">
                                        ...
                                        <select class="form-select rounded-md shadow-sm mt-1 block w-full" id="usuario_id" name="usuario_id" required>
                                            ...
                                            @foreach ($usuarios as $usuario)
                                                <option value="{{ $usuario->id }}" {{ old('usuario_id', $cuota->usuario_id) == $usuario->id ? 'selected' : '' }}>{{ $usuario->nombre . ' ' . $usuario->apellidos }}</option>
                                            @endforeach
                                        </select>
                                        @error('usuario_id')
                                    ...
                                    <div class="col-span-1 md:col-span-2">
                                        ...
                                        <input type="number" step="0.01" class="form-input rounded-md shadow-sm mt-1 block w-full" id="cuota" name="cuota" placeholder="Ingrese la cantidad anual" value="{{ old('cuota', $cuota->cuota) }}">
                                        @error('cuota')
                                            <span class="text-red-600 text-sm">{{ $message }}</span>
                                        @enderror
                                    </div>
                                    ...
                                    <div class="col-span-1">
                                        ...
                                        <select class="form-select rounded-md shadow-sm mt-1 block w-full" id="pago_2023" name="pago_2023" required>
                                            ...
                                            <option value="1" {{ old('pago_2023', $cuota->pago_2023) == '1' ? 'selected' : '' }}>Sí</option>
                                            <option value="0" {{ old('pago_2023', $cuota->pago_2023) == '0' ? 'selected' : '' }}>No</option>
                                        </select>
                                        @error('pago_2023')
                                            <span class="text-red-600 text-sm">{{ $message }}</span>
                                        @enderror
                                    ...
                                    <div class="col-span-1">
                                        ...
                                        <select class="form-select rounded-md shadow-sm mt-1 block w-full" id="pago_2024" name="pago_2024" required>
                                            <option value="">Seleccione un valor</option>
                                            <option value="1" {{ old('pago_2024', $cuota->pago_2024) == '1' ? 'selected' : '' }}>Sí</option>
                                            <option value="0" {{ old('pago_2024', $cuota->pago_2024) == '0' ? 'selected' : '' }}>No</option>
                                        </select>
                                        @error('pago_2024')
                                            <span class="text-red-600 text-sm">{{ $message }}</span>
                                        @enderror
                                    ...
                                    <div class="col-span-1">
                                        ...
                                        <select class="form-select rounded-md shadow-sm mt-1 block w-full" id="pago_2025" name="pago_2025" required>
                                            <option value="">Seleccione un valor</option>
                                            <option value="1" {{ old('pago_2025', $cuota->pago_2025) == '1' ? 'selected' : '' }}>Sí</option>
                                            <option value="0" {{ old('pago_2025', $cuota->pago_2025) == '0' ? 'selected' : '' }}>No</option>
                                        </select>
                                        @error('pago_2025')
                                            <span class="text-red-600 text-sm">{{ $message }}</span>
                                        @enderror
                                    ...
                                    <div class="col-span-1">
                                        ...
                                        <select class="form-select rounded-md shadow-sm mt-1 block w-full" id="pago_2026" name="pago_2026" required>
                                            <option value="">Seleccione un valor</option>
                                            <option value="1" {{ old('pago_2026', $cuota->pago_2026) == '1' ? 'selected' : '' }}>Sí</option>
                                            <option value="0" {{ old('pago_2026', $cuota->pago_2026) == '0' ? 'selected' : '' }}>No</option>
                                        </select>
                                        @error('pago_2026')
                                            <span class="text-red-600 text-sm">{{ $message }}</span>
                                        @enderror
                                    ...
                                    <div class="col-span-1">
                                        ...
                                        <select class="form-select rounded-md shadow-sm mt-1 block w-full" id="pago_2027" name="pago_2027" required>
                                            <option value="">Seleccione un valor</option>
                                            <option value="1" {{ old('pago_2027', $cuota->pago_2027) == '1' ? 'selected' : '' }}>Sí</option>
                                            <option value="0" {{ old('pago_2027', $cuota->pago_2027) == '0' ? 'selected' : '' }}>No</option>
                                        </select>
                                        @error('pago_2027')
                                            <span class="text-red-600 text-sm">{{ $message }}</span>
                                        @enderror
                                ...
                                <div class="flex justify-center mt-6">
                                    <button type="submit" class="px-4 py-2 bg-blue-600 text-white rounded-md hover:bg-blue-700 transition">Actualizar Cuota</button>
